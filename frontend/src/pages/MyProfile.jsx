  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 t-3 text-neutral-700'>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          {
            isEdit
            ? <select className='max-w-20 bg-gray-100'  value={userData.name} onChange={e => setUserData(prev => ({ ...prev, gender:e.target.value}))} >
